...
RSpec.describe ProductTypesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: product_type.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      product_type = ProductType.create! valid_attributes
      get :edit, params: {id: product_type.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ProductType" do
        expect {
          post :create, params: {product_type: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {product_type: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested product_type" do
        product_type = ProductType.create! valid_attributes
        put :update, params: {id: product_type.to_param, product_type: new_attributes}, session: valid_session
        product_type.reload
      ...
      it "redirects to the product_type" do
        product_type = ProductType.create! valid_attributes
        put :update, params: {id: product_type.to_param, product_type: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        product_type = ProductType.create! valid_attributes
        put :update, params: {id: product_type.to_param, product_type: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested product_type" do
      product_type = ProductType.create! valid_attributes
      expect {
        delete :destroy, params: {id: product_type.to_param}, session: valid_session
      }.to change(ProductType, :count).by(-1)
    end
